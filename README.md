...
<body>
  <div id="app">
    <aside id="sidebar">
      ...
      <p class="sub">Heatmap showing chalet coverage (green) and recommended growth areas (red/orange). Toggle layers below.</p>
      <div class="control">
      ...
      <p class="footer">Green = current coverage. Red/orange = undersupplied but strategic areas (mid-alt, 4-season potential).</p>
    </aside>
    <div id="map"></div>
  </div>
